...
if(item.classList.contains("bg-blue-300")){
  ...
  return (
    <nav className="grid grid-cols-3 gap-4 items-center border-2 my-2 h-38 bg-blue-100">
      <div className="col-span-1">
        <h2 className=" px-2 text-5xl font-bold text-blue-400">TodoList</h2>
      </div>
      <div className="grid gap-4">
        <h3 className="font-bold filterItem text-sm border-2 border-blue-200 rounded-full justify-items-center text-center py-1  hover:cursor-pointer" onClick={(e) => {dispatch(setListState(e.target.innerText.toLowerCase()));
        ...
        <h3
          ...
          className="font-bold filterItem text-sm border-2 border-blue-200 rounded-full justify-items-center text-center py-1  hover:cursor-pointer " onClick={(e) => {dispatch(setListState(e.target.innerText.toLowerCase()));
         removeBackgroundColor();
        e.target.classList.add("bg-blue-300");
       }}
        >
